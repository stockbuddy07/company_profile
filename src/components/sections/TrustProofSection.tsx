...
function MobileTrustCard({ card, index }: MobileTrustCardProps) {
  ...
  return (
    ...
    >
      <div className={`bg-background w-10 h-10 rounded-full flex items-center justify-center text-base font-bold ${card.textColor} mb-6`}>
        {card.number}
      </div>
...
export default function TrustProofSection() {
  ...
  return (
    <section ref={sectionRef} id="reputation" className="relative h-full md:h-[600vh] bg-white">
      {/* ------------------- Mobile ------------------- */}
      <div className="md:hidden py-16 px-4 w-full overflow-x-hidden">
        <div className="max-w-4xl mx-auto">
          {/* ✅ Added animated heading for mobile */}
          <div className="text-center mb-12">
            ...
            <motion.p
              ...
              className="text-sm text-primary font-normal max-w-2xl mx-auto"
            >
      ...
      <div className="hidden md:flex sticky top-0 h-screen items-center justify-center overflow-hidden">
        <motion.div style={{ opacity, scale }} className="w-full max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Horizontal animated scroll cards */}
          <div className="relative flex justify-center">
            <motion.div style={{ x }} className="flex gap-8 w-max">
              {trustProofCards.map((card) => (
                ...
                >
                  <div className={`bg-background w-12 h-12 rounded-full flex items-center justify-center text-base font-semibold ${card.textColor} mb-4`}>
                    {card.number}
                  </div>
