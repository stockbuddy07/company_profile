...
export default function GetInTouchSection() {
  ...
  return (
    ...
    <div id="get-in-touch" className="min-h-screen flex items-center justify-center">
      <section
        ref={sectionRef}
        className="relative w-full bg-[#02c3a0] overflow-hidden flex items-center justify-center py-24 md:py-32"
      >
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          {/* Row 2 */}
          <div className="absolute top-16 left-0 w-full h-16 overflow-hidden">
            <motion.div
              className="flex whitespace-nowrap"
              animate={{
                x: ['0%', '-100%'],
          ...
          {/* Row 3 */}
          <div className="absolute top-32 left-0 w-full h-16 overflow-hidden">
            <motion.div
              className="flex whitespace-nowrap"
              animate={{
                x: ['-100%', '0%'],
          ...
          {/* Row 4 */}
          <div className="absolute top-48 left-0 w-full h-16 overflow-hidden">
            <motion.div
              className="flex whitespace-nowrap"
              animate={{
                x: ['0%', '-100%'],
          ...
          {/* Row 5 */}
          <div className="absolute top-64 left-0 w-full h-16 overflow-hidden">
            <motion.div
              className="flex whitespace-nowrap"
              animate={{
                x: ['-100%', '0%'],
          ...
          {/* Row 6 */}
          <div className="absolute top-80 left-0 w-full h-16 overflow-hidden">
            <motion.div
              className="flex whitespace-nowrap"
              animate={{
                x: ['0%', '-100%'],
          ...
          {/* Row 7 */}
          <div className="absolute top-96 left-0 w-full h-16 overflow-hidden">
            <motion.div
              className="flex whitespace-nowrap"
              animate={{
                x: ['-100%', '0%'],
